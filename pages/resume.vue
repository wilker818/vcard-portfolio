  ...
  <article class="resume active" data-page="resume">
    ...
    <section class="timeline">
      ...
      <ol class="timeline-list">
        <li class="timeline-item">
          <h4 class="h4 timeline-item-title">Cruzeiro do Sul Virtual</h4>
        ...
        <li class="timeline-item">
          <h4 class="h4 timeline-item-title">Etec José Martimiano souza</h4>
    ...
    <section class="skill">
      ...
      <ul class="skills-list content-card">
        ...
        <li class="skills-item">
          <div class="title-wrapper">
            <h5 class="h5">Designer Responsive</h5>
            <data value="90">90%</data>
          </div>
        ...
        <li class="skills-item">
          <div class="title-wrapper">
            <h5 class="h5">CI/CD</h5>
            <data value="20">20%</data>
          </div>

          <div class="skill-progress-bg">
            <div class="skill-progress-fill" style="width: 20%" />
          </div>
        </li>
